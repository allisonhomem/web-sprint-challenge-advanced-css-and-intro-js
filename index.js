...
function get20s(array) {
  ...
  for(let i=0; i < array.length; i++){
    const checkYears = array[i].years.split("-",2);
    if(checkYears[0].includes('19') && checkYears[1].includes('19' || '20')){
...
const newArtist =  { 
  id: 20,
  name: "Allison Homem", 
  years: "1991 - 16 July 2021",
  genre: "Web Design", 
  nationality: "American",
  bio: "Allison loves fresh pour-overs and pastries. Sometimes you can find her staying up til midnight making pasta."
};  
